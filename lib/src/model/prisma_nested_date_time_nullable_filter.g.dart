...
part of 'prisma_nested_date_time_nullable_filter.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PrismaNestedDateTimeNullableFilter _$PrismaNestedDateTimeNullableFilterFromJson(
        Map<String, dynamic> json) =>
    $checkedCreate(
      'PrismaNestedDateTimeNullableFilter',
      json,
      ($checkedConvert) {
        final val = PrismaNestedDateTimeNullableFilter(
          equals: $checkedConvert(
              'equals', (v) => v == null ? null : DateTime.parse(v as String)),
          in_: $checkedConvert(
...
Map<String, dynamic> _$PrismaNestedDateTimeNullableFilterToJson(
    PrismaNestedDateTimeNullableFilter instance) {
