...
part of 'prisma_nested_string_filter.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PrismaNestedStringFilter _$PrismaNestedStringFilterFromJson(
        Map<String, dynamic> json) =>
    $checkedCreate(
      'PrismaNestedStringFilter',
      json,
      ($checkedConvert) {
        final val = PrismaNestedStringFilter(
...
Map<String, dynamic> _$PrismaNestedStringFilterToJson(
    PrismaNestedStringFilter instance) {
