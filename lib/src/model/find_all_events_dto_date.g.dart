...
part of 'find_all_events_dto_date.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

FindAllEventsDtoDate _$FindAllEventsDtoDateFromJson(
        Map<String, dynamic> json) =>
    $checkedCreate(
      'FindAllEventsDtoDate',
      json,
      ($checkedConvert) {
        final val = FindAllEventsDtoDate(
...
Map<String, dynamic> _$FindAllEventsDtoDateToJson(
    FindAllEventsDtoDate instance) {
