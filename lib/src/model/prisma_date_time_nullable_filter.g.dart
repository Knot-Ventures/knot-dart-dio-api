...
part of 'prisma_date_time_nullable_filter.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PrismaDateTimeNullableFilter _$PrismaDateTimeNullableFilterFromJson(
        Map<String, dynamic> json) =>
    $checkedCreate(
      'PrismaDateTimeNullableFilter',
      json,
      ($checkedConvert) {
        final val = PrismaDateTimeNullableFilter(
...
Map<String, dynamic> _$PrismaDateTimeNullableFilterToJson(
    PrismaDateTimeNullableFilter instance) {
